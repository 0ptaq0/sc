<?php
    ...
    return [
        ...
        'install'       =>  function() use($core)
        {
			...
			$core->db()->pdo()->exec("INSERT INTO `blog_tags` VALUES (1, 'hello world', 'hello-world'), (2, 'batflat', 'batflat')");
			$core->db()->pdo()->exec("INSERT INTO `blog_tags_relationship` VALUES (1, 1), (1, 2)");
